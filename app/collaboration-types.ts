...
export type RoomTask = TaskFields & { id: string; ownerId: string | null; version: string; settingsVersion?: string; pending?: string; transferBlocked?: string; workflowId?: string; publisherId?: string };
